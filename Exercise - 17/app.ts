...
while (guestList.length > 2) {
  ...
  console.log(`Sorry, ${removedGuest}, I regret that I didn't accommodate everyone for dinner due to space constraints. Your understanding means a lot to us. Let's plan something soon!`);
}
//• Print a message to each of the two people still on your list, letting them know they’re still invited.
console.log("Invitation to the remaining last two guest.");
guestList.forEach(lastTwo => console.log(`Fortunatey ${lastTwo}, You're invited to join us for dinner! Hope you can join us for good food and good company.`));
